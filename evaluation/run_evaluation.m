...
for i = 2686 : 2700,
    ...
    load([paths.cache 'weights/' file_name '_weights.mat'])
...
if ~exist([paths.cache 'results/'], 'dir'),
    mkdir([paths.cache 'results/'])
end
save([paths.cache 'results/' save_file_name '_results.mat'], 'precision', 'recall', 'ap')
